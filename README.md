...
_See [drwiggle.com/wedding/](http://www.drwiggle.com/wedding/) for a demo._
...
# Getting Started
1. `$ git clone https://github.com/drwiggle/wedding-website.git` - clone this project to your computer
